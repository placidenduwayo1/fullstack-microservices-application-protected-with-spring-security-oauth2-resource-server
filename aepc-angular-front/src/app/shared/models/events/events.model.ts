...
export enum UserEvent {
  ...
  OPEN_UI_ADD_ROLE_USER = "[User] OPEN UI ADD ROLE USER EVENT",
  OPEN_UI_REMOVE_ROLE_USER = "[User] OPEN UI REMOVE ROLE FROM USER EVENT",
  OPEN_PWD_CHANGE_UI = "[User] OPEN PWD CHANGE UI EVENT",
  SAVE_CHANGE_PWD = "[User] SAVE CHANGE PWD EVENT",
  OPEN_ROLE_UI = "[Role] OPEN ROLE UI EVENT",
  SAVE_NEW_ROLE = "[Role] SAVE NEW ROLE EVENT",
  ROLE_USER_MANAGE = "[User] MANAGE ROLE USER",
  SAVE_ROLE_USER_ADD = "[User] SAVE NEW ROLE TO USER EVENT",
  SAVE_ROLE_USER_REMOVE = "[User] SAVE REMOVE ROLE FROM USER EVENT",
}
