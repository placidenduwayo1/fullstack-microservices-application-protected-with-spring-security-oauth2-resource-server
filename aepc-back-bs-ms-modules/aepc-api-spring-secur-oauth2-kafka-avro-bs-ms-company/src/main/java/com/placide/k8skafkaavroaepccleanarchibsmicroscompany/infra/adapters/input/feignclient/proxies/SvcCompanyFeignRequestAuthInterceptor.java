...
@Slf4j
public class SvcCompanyFeignRequestAuthInterceptor implements RequestInterceptor{
    ...
    public void apply(RequestTemplate requestTemplate) {
        ...
        if(Objects.nonNull(requestAttributes)){
            ...
            if(matcher.matches()){
                ...
                log.error("[COMPANY-BS-MICROSERVICE] authorization not match");
            }
        }
        else {
            log.error("[COMPANY-BS-MICROSERVICE] Request Attributes null");
        }
    }
}
