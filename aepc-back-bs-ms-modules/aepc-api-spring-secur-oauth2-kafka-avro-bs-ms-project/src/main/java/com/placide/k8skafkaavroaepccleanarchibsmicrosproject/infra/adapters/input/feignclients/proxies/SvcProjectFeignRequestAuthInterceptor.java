...
@Slf4j
public class SvcProjectFeignRequestAuthInterceptor implements RequestInterceptor {
    ...
    public void apply(RequestTemplate requestTemplate) {
        ...
        if(Objects.nonNull(requestAttributes)){
            ...
            if(matcher.matches()){
                ...
                log.error("[PROJECT-BS-MICROSERVICE] authorization not match");
            }
        }
        else {
            log.error("[PROJECT-BS-MICROSERVICE] Request Attributes null");
        }
    }
}
